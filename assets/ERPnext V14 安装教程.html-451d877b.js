import{_ as s,o as n,c as a,e}from"./app-ce4edb7a.js";const p={},t=e(`<h1 id="erp-next使用教程" tabindex="-1"><a class="header-anchor" href="#erp-next使用教程" aria-hidden="true">#</a> erp_next使用教程</h1><div class="language-per line-numbers-mode" data-ext="per"><pre class="language-per"><code>su - root
#添加用户
adduser frappe
#将新建的用户添加到sudo组
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>gantt.html</p><div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li></li><li></li></ol>`,77),o=[t];function l(c,r){return n(),a("div",null,o)}const u=s(p,[["render",l],["__file","ERPnext V14 安装教程.html.vue"]]);export{u as default};
