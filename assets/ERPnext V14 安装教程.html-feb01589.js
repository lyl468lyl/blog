import{_ as s,o as n,c as a,e}from"./app-33a8c266.js";const p={},t=e(`<h1 id="添加frappe用户" tabindex="-1"><a class="header-anchor" href="#添加frappe用户" aria-hidden="true">#</a> 添加frappe用户</h1><div class="language-per line-numbers-mode" data-ext="per"><pre class="language-per"><code>su - root
#添加用户
adduser frappe
#将新建的用户添加到sudo组
