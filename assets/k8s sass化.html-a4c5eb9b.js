import{_ as n,o as s,c as a,e}from"./app-d0d8bb13.js";const p={},o=e(`<p>date: 2013-7-19</p><p>category: sass</p><p>tag:</p><ul><li>sass</li></ul><h1 id="sass-aps-开发文档" tabindex="-1"><a class="header-anchor" href="#sass-aps-开发文档" aria-hidden="true">#</a> sass(aps)开发文档</h1><h4 id="前提准备" tabindex="-1"><a class="header-anchor" href="#前提准备" aria-hidden="true">#</a> 前提准备</h4><p>参考:https://www.yuque.com/leifengyang/oncloud/ctiwgo#gSYVF</p><ol><li>创建aws 云主机</li></ol><p>2)设置主机密码登录</p><div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code><span class="token comment"># 编辑ssh 配置文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li></li><li></li></ol>`,14),t=[o];function l(i,c){return s(),a("div",null,t)}const d=n(p,[["render",l],["__file","k8s sass化.html.vue"]]);export{d as default};
