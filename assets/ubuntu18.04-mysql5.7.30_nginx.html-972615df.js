import{_ as s,o as n,c as a,e}from"./app-9bfb3056.js";const p={},o=e(`<h1 id="ubuntu18-04-安装mysql5-7-30" tabindex="-1"><a class="header-anchor" href="#ubuntu18-04-安装mysql5-7-30" aria-hidden="true">#</a> ubuntu18.04 安装mysql5.7.30</h1><div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code>下载源文件
...
<span class="token comment">#拉取 nginx 最新版镜像，然后简单启动一个 nginx 容器</span>
docker pull nginx<span class="token punctuation">:</span>latest
docker run <span class="token operator">--</span>name nginx01 <span class="token operator">-d</span> <span class="token operator">-p</span> <span class="token number">80</span><span class="token punctuation">:</span><span class="token number">80</span> nginx

<span class="token comment">#下载nginx.conf</span>
sudo mkdir <span class="token operator">-p</span> <span class="token operator">/</span>home<span class="token regex">/docker/ngin</span><span class="token operator">x</span><span class="token operator">/</span><span class="token punctuation">{</span>log<span class="token punctuation">,</span>ssl<span class="token punctuation">,</span>html<span class="token punctuation">,</span>conf<span class="token operator">/</span>conf<span class="token operator">.</span>d<span class="token punctuation">}</span>
sudo chmod <span class="token operator">-R</span> <span class="token number">755</span> <span class="token operator">/</span>home<span class="token regex">/docker/ngin</span><span class="token operator">x</span><span class="token operator">/</span>html

docker cp nginx01<span class="token punctuation">:</span><span class="token regex">/etc/ngin</span><span class="token operator">x</span><span class="token operator">/</span>nginx<span class="token operator">.</span>conf <span class="token operator">/</span>home<span class="token regex">/docker/ngin</span><span class="token operator">x</span><span class="token regex">/conf/nginx</span><span class="token operator">.</span>conf
docker cp nginx01<span class="token punctuation">:</span><span class="token regex">/etc/ngin</span><span class="token operator">x</span><span class="token operator">/</span>conf<span class="token operator">.</span>d<span class="token operator">/</span><span class="token keyword">default</span><span class="token operator">.</span>conf <span class="token operator">/</span>home<span class="token regex">/docker/ngin</span><span class="token operator">x</span><span class="token operator">/</span>conf<span class="token operator">/</span>conf<span class="token operator">.</span>d<span class="token operator">/</span><span class="token keyword">default</span><span class="token operator">.</span>conf

<span class="token comment">#删除容器和镜像</span>
docker stop nginx01
docker rm nginx01


<span class="token comment">#重新配置nginx</span>
...
<span class="token operator">--</span>name nginx<span class="token operator">-</span>flask <span class="token operator">\\</span>
<span class="token operator">--</span>restart<span class="token operator">=</span>always <span class="token operator">\\</span>
<span class="token operator">--</span>privileged<span class="token operator">=</span>true <span class="token operator">\\</span>
...
server <span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),t=[o];function r(l,c){return n(),a("div",null,t)}const d=s(p,[["render",r],["__file","ubuntu18.04-mysql5.7.30_nginx.html.vue"]]);export{d as default};
