import{_ as s,o as n,c as a,e}from"./app-402b2ba9.js";const p={},t=e(`<h1 id="erp-next使用教程" tabindex="-1"><a class="header-anchor" href="#erp-next使用教程" aria-hidden="true">#</a> erp_next使用教程</h1><div class="language-per line-numbers-mode" data-ext="per"><pre class="language-per"><code>su - root
#添加用户
adduser frappe
#将新建的用户添加到sudo组
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ol><p>#添加div到html $(&quot;<div class="perm-engine" style="min-height:200px;padding:15px;">sss</div>&quot;).appendTo( page.main );</p><p>#找到html元素,并添加事件 page.main.find(&quot;.btn1&quot;).click(function(){ console.log(&quot;click&quot;) })</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
9. 

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,80),o=[t];function l(c,r){return n(),a("div",null,o)}const u=s(p,[["render",l],["__file","ERPnext V14 安装教程.html.vue"]]);export{u as default};
