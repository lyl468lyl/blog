import{_ as e,o as n,c as s,e as a}from"./app-9bfb3056.js";const l={},i=a(`<h1 id="qcadoo开发文档" tabindex="-1"><a class="header-anchor" href="#qcadoo开发文档" aria-hidden="true">#</a> qcadoo开发文档</h1><h4 id="一-postgres数据库安装" tabindex="-1"><a class="header-anchor" href="#一-postgres数据库安装" aria-hidden="true">#</a> 一 .postgres数据库安装</h4><ol><li><p>输入以下命令安装PostgreSQL</p><div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code>sudo apt install postgresql postgresql<span class="token operator">-</span>contrib
