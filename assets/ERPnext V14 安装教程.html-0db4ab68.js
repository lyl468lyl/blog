import{_ as n,o as s,c as a,e}from"./app-8987541d.js";const p={},t=e(`<h1 id="erp-next使用教程" tabindex="-1"><a class="header-anchor" href="#erp-next使用教程" aria-hidden="true">#</a> erp_next使用教程</h1><div class="language-per line-numbers-mode" data-ext="per"><pre class="language-per"><code>su - root
#添加用户
adduser frappe
#将新建的用户添加到sudo组
...
\`\`\`
</code></pre><ol start="8"><li><p>frappe doctype文档操作</p><div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code><span class="token comment">#请求地址:</span>
http<span class="token punctuation">:</span><span class="token operator">//</span><span class="token v-string string">192.168.50.23</span><span class="token operator">/</span>api<span class="token operator">/</span>method<span class="token operator">/</span>library_management<span class="token operator">.</span>library_management<span class="token operator">.</span>doctype<span class="token operator">.</span>article<span class="token operator">.</span>article<span class="token operator">.</span>test


<span class="token comment">#1. 文档更新</span>
<span class="token variable">@frappe</span><span class="token operator">.</span>whitelist<span class="token punctuation">(</span><span class="token punctuation">)</span>
def test<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
	doc <span class="token operator">=</span> frappe<span class="token operator">.</span>get_doc<span class="token punctuation">(</span><span class="token string">&#39;Article&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;bf2207a914&#39;</span><span class="token punctuation">)</span>
	doc<span class="token operator">.</span>address <span class="token operator">=</span> <span class="token string">&#39;wang&#39;</span>
	doc<span class="token operator">.</span>save<span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<span class="token comment">#1.1 文档更新</span>

<span class="token variable">@frappe</span><span class="token operator">.</span>whitelist<span class="token punctuation">(</span><span class="token punctuation">)</span>
def test<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
	doc <span class="token operator">=</span> frappe<span class="token operator">.</span>get_doc<span class="token punctuation">(</span><span class="token string">&#39;Article&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;bf2207a914&#39;</span><span class="token punctuation">)</span>
	doc<span class="token operator">.</span>db_set<span class="token punctuation">(</span><span class="token string">&quot;address&quot;</span><span class="token punctuation">,</span><span class="token string">&quot;成都&quot;</span><span class="token punctuation">)</span>
	frappe<span class="token operator">.</span>db<span class="token operator">.</span>commit<span class="token punctuation">(</span><span class="token punctuation">)</span>
	
<span class="token comment">#1.2 自动提交更新</span>

	<span class="token variable">@frappe</span><span class="token operator">.</span>whitelist<span class="token punctuation">(</span><span class="token punctuation">)</span>
  def test<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
	doc <span class="token operator">=</span> frappe<span class="token operator">.</span>get_doc<span class="token punctuation">(</span><span class="token string">&#39;Article&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;bf2207a914&#39;</span><span class="token punctuation">)</span>
	doc<span class="token operator">.</span>db_set<span class="token punctuation">(</span><span class="token string">&#39;address&#39;</span><span class="token punctuation">,</span> <span class="token string">&quot;xxx&quot;</span><span class="token punctuation">,</span> commit<span class="token operator">=</span>True<span class="token punctuation">)</span>
	
<span class="token comment">#2. 文档插入</span>

doc <span class="token operator">=</span> frappe<span class="token operator">.</span>get_doc<span class="token punctuation">(</span><span class="token punctuation">{</span>
		<span class="token string">&#39;doctype&#39;</span><span class="token punctuation">:</span> <span class="token string">&#39;Article&#39;</span><span class="token punctuation">,</span>
		<span class="token string">&#39;article_name&#39;</span><span class="token punctuation">:</span> <span class="token string">&#39;aaa&#39;</span>
	<span class="token punctuation">}</span><span class="token punctuation">)</span>
	doc<span class="token operator">.</span>insert<span class="token punctuation">(</span><span class="token punctuation">)</span>
	frappe<span class="token operator">.</span>db<span class="token operator">.</span>commit<span class="token punctuation">(</span><span class="token punctuation">)</span>

<span class="token comment">#3. 文档插入</span>
doc <span class="token operator">=</span> frappe<span class="token operator">.</span>new_doc<span class="token punctuation">(</span><span class="token string">&#39;Article&#39;</span><span class="token punctuation">)</span>
doc<span class="token operator">.</span>article_name <span class="token operator">=</span> <span class="token string">&#39;New Task 2&#39;</span>
doc<span class="token operator">.</span>insert<span class="token punctuation">(</span><span class="token punctuation">)</span>
frappe<span class="token operator">.</span>db<span class="token operator">.</span>commit<span class="token punctuation">(</span><span class="token punctuation">)</span>

<span class="token comment">#4. 文档中类的方法调用</span>
<span class="token comment">#1) Article 类的方法如下</span>
import frappe
from frappe<span class="token operator">.</span>model<span class="token operator">.</span>document import Document

class Article<span class="token punctuation">(</span>Document<span class="token punctuation">)</span><span class="token punctuation">:</span>
	def on_insert<span class="token punctuation">(</span>self<span class="token punctuation">)</span><span class="token punctuation">:</span>
		<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">&quot;inserting article&quot;</span><span class="token punctuation">)</span>

<span class="token comment">#任何接口调用上述方法</span>
<span class="token comment">#http://192.168.50.23/api/method/library_management.library_management.api.test.test</span>
<span class="token variable">@frappe</span><span class="token operator">.</span>whitelist<span class="token punctuation">(</span><span class="token punctuation">)</span>
def test<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
	doc <span class="token operator">=</span> frappe<span class="token operator">.</span>get_doc<span class="token punctuation">(</span><span class="token string">&#39;Article&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;bf2207a914&#39;</span><span class="token punctuation">)</span>
	doc<span class="token operator">.</span>run_method<span class="token punctuation">(</span><span class="token string">&#39;on_insert&#39;</span><span class="token punctuation">)</span>
...
class Article<span class="token punctuation">(</span>Document<span class="token punctuation">)</span><span class="token punctuation">:</span>
	def before_save<span class="token punctuation">(</span>self<span class="token punctuation">)</span><span class="token punctuation">:</span>
		...
		<span class="token keyword">if</span> self<span class="token operator">.</span>article_name<span class="token operator">==</span><span class="token string">&quot;aa&quot;</span><span class="token punctuation">:</span>
			frappe<span class="token operator">.</span>throw<span class="token punctuation">(</span><span class="token string">&quot;con not aa&quot;</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li><li></li><li></li><li></li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
8. 总结
测试中ssss


</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,81),o=[t];function l(c,i){return s(),a("div",null,o)}const u=n(p,[["render",l],["__file","ERPnext V14 安装教程.html.vue"]]);export{u as default};
