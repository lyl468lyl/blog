...
　　
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>2.在resources目录下使用asar指令进行加密</strong></p><p>asar pack ./app app.asar</p><p><strong>将原来的app文件夹删除</strong>就可以了，这样生成的app.asar就加密了之前的源代码，保证了安全性</p><p>![image-20230321185600790](/Users/li/Library/Application Support/typora-user-images/image-20230321185600790.png)</p>`,33),e=[o];function c(i,l){return s(),a("div",null,e)}const r=n(p,[["render",c],["__file","Electron构建Vue项目.html.vue"]]);export{r as default};
