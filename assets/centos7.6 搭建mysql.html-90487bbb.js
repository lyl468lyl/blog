import{_ as s,o as n,c as a,e}from"./app-6b70759c.js";const p={},o=e(`<h1 id="centos7-6-搭建mysql" tabindex="-1"><a class="header-anchor" href="#centos7-6-搭建mysql" aria-hidden="true">#</a> centos7.6 搭建mysql</h1><p>下载:</p><p>https://downloads.mysql.com/archives/community/</p><p>version:5.7.33</p><p>sysem:redhat Enterprice oracle Liunx</p><p>osversion red hat enterprice linux 7 (x86 64-bit)</p><div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code>mkdir <span class="token operator">/</span>opt<span class="token operator">/</span>software<span class="token operator">/</span>mysql
