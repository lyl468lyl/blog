import{_ as n,o as s,c as a,e}from"./app-d0d8bb13.js";const p={},o=e(`<h1 id="mogodb-使用教程" tabindex="-1"><a class="header-anchor" href="#mogodb-使用教程" aria-hidden="true">#</a> mogodb 使用教程</h1><ol><li><p>安装使用</p><div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code>sudo apt<span class="token operator">-</span>get install mongodb
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="6"><li><p>配置:要想让别的主机连接安装好的mongodb需要修改配置文件，配置文件位于/etc目录下</p><div class="language-perl&#39; line-numbers-mode" data-ext="perl&#39;"><pre class="language-perl&#39;"><code> vi /etc/mongod.conf

将bind_ip = 127.0.0.1 修改为0.0.0.0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>mongo日志的查看</p><div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code> <span class="token comment">#vi /etc/mongod.conf</span>
 查看配置<span class="token punctuation">:</span>
logAppend<span class="token punctuation">:</span> true
path<span class="token punctuation">:</span> <span class="token operator">/</span>var<span class="token operator">/</span>log<span class="token regex">/mongodb/mongod</span><span class="token operator">.</span>log

日志在<span class="token operator">/</span>var<span class="token operator">/</span>log<span class="token regex">/mongodb/mongod</span><span class="token operator">.</span>log路径下
创建日志文件夹
mkdir <span class="token operator">/</span>var<span class="token operator">/</span>log<span class="token operator">/</span>mongodb
chmod <span class="token operator">-R</span> <span class="token number">777</span> <span class="token operator">/</span>var<span class="token operator">/</span>log<span class="token operator">/</span>mongodb
启动
service mongod start
查看端口占用
netstat <span class="token operator">-</span>lntup<span class="token operator">|</span>grep <span class="token number">27017</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>java 开发相关依赖</p><div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code><span class="token filehandle symbol">&lt;dependency&gt;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>图形界面工具</p></li></ol><div class="language-pel line-numbers-mode" data-ext="pel"><pre class="language-pel"><code>https://www.mongodb.com/try/download/community
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol start="11"><li><p>基本操作</p><div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code><span class="token number">1</span><span class="token operator">.</span>mongoTemplate<span class="token operator">.</span>findAll<span class="token punctuation">(</span>Student<span class="token operator">.</span>class<span class="token punctuation">)</span><span class="token punctuation">:</span> 查询Student文档的全部数据
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ol>`,6),l=[o];function t(i,c){return s(),a("div",null,l)}const d=n(p,[["render",t],["__file","mogodb 使用教程.html.vue"]]);export{d as default};
