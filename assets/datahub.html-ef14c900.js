import{_ as n,o as s,c as a,e as t}from"./app-8afc1b14.js";const p={},e=t(`<h1 id="data-hub-功能实现" tabindex="-1"><a class="header-anchor" href="#data-hub-功能实现" aria-hidden="true">#</a> data hub 功能实现</h1><h4 id="一-销售订单将仿真数据自动插入datahub功能" tabindex="-1"><a class="header-anchor" href="#一-销售订单将仿真数据自动插入datahub功能" aria-hidden="true">#</a> 一 . 销售订单将仿真数据自动插入datahub功能</h4><p>源码修改:</p><ol><li><p>/opt/module/frappe-bench/erpnext/erpnext/controllers/selling_controller.py</p><div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code></code></pre><div class="line-numbers" aria-hidden="true"></div></div></li></ol><p>def set_total_in_words(self): from frappe.utils import money_in_words</p><pre><code>	if self.meta.get_field(&quot;base_in_words&quot;):
