import{_ as l,r as i,o as p,c as r,a as n,b as s,d as t,e as a}from"./app-7d162ccd.js";const o={},c=a('<p>---</p><p>date: 2013-6-25</p><p>category: linux</p><p>tag:</p><p>- gitlab</p><p>---</p><h1 id="ubuntu18-04-安装gitlab" tabindex="-1"><a class="header-anchor" href="#ubuntu18-04-安装gitlab" aria-hidden="true">#</a> ubuntu18.04 安装gitlab</h1><h2 id="安装依赖" tabindex="-1"><a class="header-anchor" href="#安装依赖" aria-hidden="true">#</a> 安装依赖</h2>',8),d={href:"https://so.csdn.net/so/search?q=gitlab&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},u=a(`<div class="language-perl line-numbers-mode" data-ext="perl"><pre class="language-perl"><code>sudo apt update
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于<code>postfix</code>的安装，请在出现提示时选择“ <strong>Internet站点”</strong>。在下一个屏幕上，输入服务器的域名以配置系统发送邮件的方式</p><h2 id="安装gitlab" tabindex="-1"><a class="header-anchor" href="#安装gitlab" aria-hidden="true">#</a> 安装gitlab</h2>`,3),v={href:"https://so.csdn.net/so/search?q=ubuntu&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},b=a(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>lsb_release -a
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,59);function g(m,k){const e=i("ExternalLinkIcon");return p(),r("div",null,[c,n("p",null,[s("安装"),n("a",d,[s("gitlab"),t(e)]),s("前需要对其依赖包进行安装，确保符合安装gitlab的条件")]),u,n("p",null,[s("安装gitlab前需要确定"),n("a",v,[s("ubuntu"),t(e)]),s("的版本代号，才能选择对应的gitlab版本。")]),b])}const _=l(o,[["render",g],["__file","商简智能开发组-ubuntu18.04 部署gitlab.html.vue"]]);export{_ as default};
